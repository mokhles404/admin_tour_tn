...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      DrawerList(
        index: DrawerIndex.place,
        labelName: 'Endroits',
        icon: Icon(Icons.account_balance),
      ),
      DrawerList(
        index: DrawerIndex.event,
        labelName: 'Evénements',
        icon: Icon(Icons.calendar_today),
      ),
      DrawerList(
        index: DrawerIndex.Help,
        labelName: 'Réclamations',
      ...
      DrawerList(
        ...
        labelName: 'patrimoine immatériel',
        icon: Icon(Icons.history_edu),
      ),
      DrawerList(
        index: DrawerIndex.About,
        labelName: 'À propos de nous',
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                    ...
                    child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.blue : AppTheme.nearlyBlack),
                      ...
                      : Icon(listData.icon?.icon, color: widget.screenIndex == listData.index ? Colors.red[900] : AppTheme.nearlyBlack),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.red[900] : AppTheme.nearlyBlack,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
